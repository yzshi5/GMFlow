...
post_fix = "x_pred_unif_filter_075_t48_128M_scaling_testdata" # 1c_add, 1c_add_tr
...
def build_scaling_hdf5(
    h5_path: Path = SAVE_PLOT_ROOT / "scaling_subset_075_horizontal_new.h5",
    stride: int = 1,
    batch_size: int = 4,
    ...
    with h5py.File(h5_path, "w") as f:
        ...
        for start in range(0, n_events, batch_size):
            ...
            syn_denorm = denormalize_displacement(final_output).cpu().numpy()
